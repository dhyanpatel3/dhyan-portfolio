...
const Contact = () => {
  return (
    <div id="contact" className="flex min-[70vh] min-w-full items-center justify-center">
     ...
     <p className="text-center text-lg font-semibold text-gray-500">Want to chat? Send me an E-mail through this button and I"ll respond
      whenever I can.
     </p>
